export class StringHelper {
    private static diacriticsObject = {
        0xC0: 'A',
        0xC1: 'A',
        0xC2: 'A',
        0xC3: 'A',
    ...
    public static removeDiacritics(str) {
        return str.replace(/[À-ž]/g, function(ch) {
            return StringHelper.diacriticsObject[ch.charCodeAt(0)] || ch;
        });
    }
     ...
     *
     * @param {string} name
     * @returns {string} the first two initials or the first letter present on 'name'
     */
